                ...
                <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
                    ...
                    >
                        ...
                        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
                            ...
                            <Grid container>
                                <Grid item xs>
                                    <ul><CustomLink to='/resetpass' className='backToSignup'>Forgot password?</CustomLink></ul>
                                </Grid>
                                <Grid item>
                                    <ul><CustomLink to='/signup' className='backToSignup'>Don't have an account? Sign Up</CustomLink></ul>
                                </Grid>
                            </Grid>
                        </Box>
                    </Box>
